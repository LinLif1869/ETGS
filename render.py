...
from utils.efficiency_utils import add_efficiency   
...
def render_set(model_path, name, iteration, views, gaussians, pipeline, background, train_test_exp, separate_sh):
    ...
    for idx, view in enumerate(pbar):    
        ...
        # --------------- render process ---------------
        temperature = gaussians.temperature_closed_form([view.idx])
        override_color = gaussians.temperature_to_gray(temperature)
        rendering = render(view, gaussians, pipeline, background, use_trained_exp=train_test_exp, separate_sh=separate_sh, override_color= override_color)["render"]
        # ----------------------------------------------
